...
public interface MapInfoRenderer {
    ...
    public void onMapClick(Sector s, int tileX, int tileY, int internalX, int internalY);

    public void onMapDrag(Sector s, int tileX, int tileY, int internalX, int internalY);
}
